  ...
  return (
    <div id='etapa-idiomas' className="max-w-300 w-4/5 mx-auto pb-12">
      <section className="grid md:grid-cols-2">
        <div className="p-8 md:p-15 text-white rounded-t-3xl md:rounded-tr-none md:rounded-l-3xl md:rounded-bl-3xl bg-[#005596] space-y-8">
          <h2 className='font-bold text-4xl leading-12 text-center md:text-start'>Etapa Idiomas: educação bilíngue em uma jornada prazerosa</h2>
          <p className='text-lg'>
        ...
        <Image
          src={ImageEtapaIdiomas}
          alt="Ilustração colorida com rostos de crianças e animais desenhados em estilo cartoon, acompanhada da frase ‘Somos cidadãos do mundo, somos bilíngues! Uma nova forma de aprender.’ em destaque no centro."
